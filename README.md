...
across e-commerce and bank credit card data, with full model
explainability and business recommendations.

---

## Project Overview

Adey Innovations needed a unified fraud detection system that handles:
